...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: '/favicon.ico?v=20260916-centered', sizes: 'any' },
      { url: '/favicon-32x32.png?v=20260916-centered', sizes: '32x32', type: 'image/png' },
      { url: '/favicon-16x16.png?v=20260916-centered', sizes: '16x16', type: 'image/png' }
    ],
    apple: [{ url: '/apple-touch-icon.png?v=20260916-centered', sizes: '180x180', type: 'image/png' }],
  },
