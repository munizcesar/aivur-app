            ...
            <main className="flex-1 min-w-0 flex flex-col gap-6">
              ...
              {trilhasPanelSlot && (
                <section 
                  ...
                  className="w-full min-h-[220px] shrink-0 rounded-2xl border border-indigo-500/20 bg-gradient-to-br from-slate-900 via-slate-900/90 to-indigo-950/40 p-6 shadow-xl relative overflow-hidden transition-all"
                >
