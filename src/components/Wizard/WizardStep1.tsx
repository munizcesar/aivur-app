    ...
    <div className={styles.wizardStep}>
      ...
      <div className={styles.modeGrid}>
        ...
        >
          ...
          <div className={styles.modeInfo}>
            <strong>Trilhas de Estudo</strong>
            <span className={styles.modeSubtitle}>Gere um cronograma inteligente e personalizado com IA baseado no seu edital ou matéria.</span>
          </div>
          
          <ul className={styles.modeBenefits}>
            <li>
              <div className={styles.benefitCheck}><Check width={14} height={14} strokeWidth={3} /></div>
              Cole editais completos ou tópicos isolados.
            </li>
            <li>
              <div className={styles.benefitCheck}><Check width={14} height={14} strokeWidth={3} /></div>
              Gere teoria e dicas focadas na sua banca.
            </li>
            <li>
              <div className={styles.benefitCheck}><Check width={14} height={14} strokeWidth={3} /></div>
              Estude offline com sincronização inteligente.
            </li>
          </ul>

          <div className={styles.modeTip}>
            <Lightbulb width={16} height={16} strokeWidth={2.5} />
            <span><strong>Dica:</strong> comece colando a parte de conhecimentos específicos do seu edital.</span>
          </div>
        </button>
      </div>
    </div>
