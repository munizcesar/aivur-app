...
export default function ResumeTab() {
  ...
  return <article className="my-4 w-full rounded-2xl border border-slate-200 bg-white p-6 text-slate-800 shadow-sm dark:border-slate-700 dark:bg-[#0b1d2b] dark:text-slate-100 md:p-10">
