...
function AivoTooltip({ children, colors = PALETTE.light, variant = "glass" }) {
  const actualColors = colors || PALETTE.light;
  return (
    <h2 style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 11.5, letterSpacing: "0.08em", textTransform: "uppercase", color: actualColors.inkSoft, fontWeight: 500, margin: 0 }}>
      {children}
    </h2>
  );
}
