...
async function scenario1() {
  ...
  log("ℹ️", `C1: fonte detectada = ${source}`);
...
async function scenario3_errosVazio() {
  ...
  log("ℹ️", "C3: Array.isArray guard converte undefined→[] corretamente");
}
...
async function run() {
  ...
  try {
    ...
    log("ℹ️", "Servidor respondendo em localhost:3000");
  } catch {
